...
class TrainerAnalyticsPage extends StatefulWidget {
  ...
  @override
  State<TrainerAnalyticsPage> createState() =>
      _TrainerAnalyticsPageState();
}

class _TrainerAnalyticsPageState
    extends State<TrainerAnalyticsPage> {
  bool _loading = true;
  String? _error;
  ...
  Future<void> _fetchAnalytics() async {
    ...
    try {
      ...
      //       "workout_name": "Weekly Strength Plan",
      //       "total_exercises": 2,
      ...
      //
      // IMPORTANT:
      // The backend sends the list using "members".
      // ========================================================
      ...
      setState(() {
        _loading = false;
        _error =
            'Failed to load today workout analytics.';
      });
    }
  }
